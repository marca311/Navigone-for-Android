...
public class NaviGone extends FragmentActivity implements DateSetPicker.onDateSetListener, TimeSetPicker.onTimeSetListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // Setup base map
        ...
        this.mainMap = new MapView(this, 256);
        rl.addView(this.mainMap, new RelativeLayout.LayoutParams(LayoutParams.FILL_PARENT,
                        LayoutParams.FILL_PARENT));
        this.mainMap.setBuiltInZoomControls(true);

        
        this.mainMap.getController().setZoom(7);
        this.mainMap.getController().setCenter(new GeoPoint(51500000, 5400000));
        ...
        this.tilesOverlay = new TilesOverlay(mProvider, this.getBaseContext());
    ...
    private void initiateLocationFields() {
        ...
        MSSuggestionBoxListener originListener = new MSSuggestionBoxListener(1);
        ...
        MSSuggestionBoxListener destinationListener = new MSSuggestionBoxListener(2);
